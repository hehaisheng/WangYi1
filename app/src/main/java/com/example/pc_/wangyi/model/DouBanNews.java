...
public class DouBanNews {
    ...
    public ArrayList<DouBanNews.posts> getPosts() {
        return posts;
    }

    public void setPosts(ArrayList<DouBanNews.posts> posts) {
        this.posts = posts;
    }
    ...
    public class posts {
        ...
        public class thumbs {
            ...
            public DouBanNews.posts.medium getMedium() {
                return medium;
            }

            public void setMedium(DouBanNews.posts.medium medium) {
                this.medium = medium;
            }
            ...
            public DouBanNews.posts.large getLarge() {
                return large;
            }

            public void setLarge(DouBanNews.posts.large large) {
                this.large = large;
            }
            ...
            public DouBanNews.posts.small getSmall() {
                return small;
            }

            public void setSmall(DouBanNews.posts.small small) {
                this.small = small;
            }
        ...
        public DouBanNews.author getAuthor() {
            return author;
        }

        public void setAuthor(DouBanNews.author author) {
            this.author = author;
        }
