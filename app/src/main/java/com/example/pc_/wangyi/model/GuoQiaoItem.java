...
public class GuoQiaoItem  {
    ...
    public ArrayList<GuoQiaoItem.result> getResult() {
        return result;
    }

    public void setResult(ArrayList<GuoQiaoItem.result> result) {
        this.result = result;
    }
    ...
    public class result {
        ...
        public GuoQiaoItem.source_data getSource_data() {
            return source_data;
        }

        public void setSource_data(GuoQiaoItem.source_data source_data) {
