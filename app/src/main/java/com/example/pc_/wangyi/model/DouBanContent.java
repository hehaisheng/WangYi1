...
public class DouBanContent {
    ...
    private ArrayList<DouBanNews.posts.thumbs> thumbs;
    ...
    private ArrayList<DouBanNews.posts.thumbs> photos;
    ...
    public ArrayList<DouBanNews.posts.thumbs> getThumbs() {
        return thumbs;
    }

    public void setThumbs(ArrayList<DouBanNews.posts.thumbs> thumbs) {
        this.thumbs = thumbs;
    }
    ...
    public ArrayList<DouBanNews.posts.thumbs> getPhotos() {
        return photos;
    }

    public void setPhotos(ArrayList<DouBanNews.posts.thumbs> photos) {
        this.photos = photos;
    }
